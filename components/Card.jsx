...
export default function Card() {
  return (
    ...
    <div className="max-w-xs lg:max-w-sm bg-yellow-500 border border-yellow-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 my-6 lg:my-12 mx-2git m-7">
      <a href="#">
    <Scroll/>
      </a>
